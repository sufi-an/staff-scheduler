...
export function CreateStaffForm() {
  ...
  const onSubmit = async (data: StaffFormValues) => {
    ...
    try {
      ...
      router.push("/staff") // Redirect to list
      router.refresh() 
    } catch (error: any) {
  ...
  // Helper to sync Select with React Hook Form manually
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Input id="jobTitle" placeholder="Senior Designer" {...register("jobTitle")} />
          ...
          <div className="space-y-2">
            ...
            <Input id="nationality" placeholder="e.g. American, Japanese" {...register("nationality")} />
